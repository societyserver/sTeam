 ...
 * 
 * $Id: secure_n_one.pike,v 1.1 2008/03/31 13:39:57 exodusd Exp $
 */

constant cvs_version="$Id: secure_n_one.pike,v 1.1 2008/03/31 13:39:57 exodusd Exp $";

inherit "/kernel/module";
inherit "/kernel/db_n_one";

#include <macros.h>
#include <events.h>

/**
 * called to initiate the database connection connected to this table.
 *  
 * @param 
 * @return 
...
{
    load_db_mapping();
    LOG("connected "+get_object_id()+"with "+tablename());
}
